...
# === 5. Mise à jour système et installation LAMP/fail2ban ===
apt update && apt upgrade -y
apt install -y apache2 mariadb-server php php-mysql libapache2-mod-php fail2ban unzip wget iptables-persistent ca-certificates gpg apt-transport-https

# === 6. Sécurisation iptables (firewall minimal LAMP) ===
PORT_SSH=22
...
-A OUTPUT -p tcp --dport $PORT_SSH -j ACCEPT
...
systemctl status apache2 mariadb fail2ban openproject || true
